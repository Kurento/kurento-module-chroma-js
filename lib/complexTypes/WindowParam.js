...
function WindowParam(windowParamDict){
  ...
  checkType('int', 'windowParamDict.topRightCornerX', windowParamDict.topRightCornerX, true);
  checkType('int', 'windowParamDict.topRightCornerY', windowParamDict.topRightCornerY, true);
  checkType('int', 'windowParamDict.width', windowParamDict.width, true);
  checkType('int', 'windowParamDict.height', windowParamDict.height, true);
